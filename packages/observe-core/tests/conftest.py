...
import pytest
from observe_core import ObserveSettings, clear_context, configure, get_stats, shutdown
...
@pytest.fixture
def stats() -> Callable[[], dict]:
    """Snapshot accessor for internal counters."""
    return get_stats
